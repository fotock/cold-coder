...
#有密码:
openssl smime -decrypt -binary -inform DEM -inkey privatekey.pem -in largeFile_enc.tgz -out largeFile_dec.tgz -passin pass:YOUR_PASSWORD
```
### 性能
...
openssl  smime -decrypt -binary -inform DEM -inkey privatekey.pem -in a_enc.mkv -out a_dec.mkv -passin pass:YOUR_PASSWORD
